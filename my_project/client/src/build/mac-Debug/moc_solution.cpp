...
static constexpr auto qt_meta_stringdata_ZN8SolutionE = QtMocHelpers::stringData(
    "Solution",
    "displaySolution",
    "",
    "solution",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8SolutionE[] = {
...
Q_CONSTINIT const QMetaObject Solution::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8SolutionE.offsetsAndSizes,
    qt_meta_data_ZN8SolutionE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8SolutionE_t,
        // Q_OBJECT / Q_GADGET
...
void Solution::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->displaySolution((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
...
void *Solution::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8SolutionE.stringdata0))
